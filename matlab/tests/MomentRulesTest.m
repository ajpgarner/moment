...
%CREATEMOMENTRULESTEST Unit tests for moment_rules mex function
    methods (Test)
        function Monolith_Empty(testCase)
            ...
            monolith = mtk('moment_rules', ref_id, rules_id , 'matrix');
            testCase.verifyEqual(monolith, sparse(eye(7)))
        end
        
         function Monolith_YtoX(testCase)
            ref_id = mtk('algebraic_matrix_system', 2);
            [~] = mtk('word_list', ref_id, 2, 'register_symbols');
            % 1, x, y, xx, xy, yy; only xy has imaginary part.
            rules_id = mtk('create_moment_rules', ref_id, ...
         ...
         function Monolith_YtoXplusConstant(testCase)
            ref_id = mtk('algebraic_matrix_system', 2);
            [~] = mtk('word_list', ref_id, 2, 'register_symbols');
            % 1, x, y, xx, xy, yy; only xy has imaginary part.
            rules_id = mtk('create_moment_rules', ref_id, ...
         ...
         function Monolith_XYtoXplusConstant(testCase)
            ref_id = mtk('algebraic_matrix_system', 2);
            [~] = mtk('word_list', ref_id, 2, 'register_symbols');
            % 1, x, y, xx, xy, yy; only xy has imaginary part.
            rules_id = mtk('create_moment_rules', ref_id, ...
         ...
         function Monolith_XYtoXplusIY(testCase)
            ref_id = mtk('algebraic_matrix_system', 2);
            [~] = mtk('word_list', ref_id, 2, 'register_symbols');
            % 1, x, y, xx, xy, yy; only xy has imaginary part.
            rules_id = mtk('create_moment_rules', ref_id, ...
         ...
         function Monolith_ReXYtoX(testCase)
            ref_id = mtk('algebraic_matrix_system', 2);
            [~] = mtk('word_list', ref_id, 2, 'register_symbols');
            % 1, x, y, xx, xy, yy; only xy has imaginary part.
            rules_id = mtk('create_moment_rules', ref_id, ...
         ...
         function Monolith_ImXYtoX(testCase)
