...
cg_bas = npatk('collins_gisin', ...
               setting.GetMatrixSystem.RefId, 'basis')
cg_sym = npatk('collins_gisin', ...
               setting.GetMatrixSystem.RefId, 'symbols')
cg_seq = npatk('collins_gisin', ...
               setting.GetMatrixSystem.RefId, 'sequences')