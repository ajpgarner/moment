...
namespace NPATK::Tests {
    ...
    TEST(LinearCombo, CreateThreeElems) {
    ...
    TEST(LinearCombo, Addition_NoOverlap) {
    ...
    TEST(LinearCombo, Addition_Interleaved) {
    ...
    TEST(LinearCombo, Addition_Overlapped1) {
    ...
    TEST(LinearCombo, Addition_Overlapped2) {
        const LinearCombo listA{{1, 10.0}, {2, 30.0}};
    ...
    TEST(LinearCombo, Addition_Overlapped3) {
    ...
    TEST(LinearCombo, MultiplyFactor) {
        const LinearCombo listA{{1, 10.0}, {3, 30.0}};
        const LinearCombo expected{{1, 30.0}, {3, 90.0}};
