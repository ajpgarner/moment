...
namespace Moment::Tests {
    ...
    TEST(Symbolic_MomentSubstitutionRulebook, CompareByOpHash) {
        ...
        MomentSubstitutionRulebook::CompareByOpHash comparator{symbols};
    ...
    TEST(Symbolic_SymbolCombo, CompareByOpHash_NontrivialHermitian) {
