...
namespace Moment::Inflation {
    ...
    void InflationMatrixSystem::on_new_symbols_registered(const WriteLock& write_lock,
    ...
    InflationMatrixSystem::create_extended_matrix(const WriteLock &lock, const ExtendedMatrixIndex &index,
    ...
    void InflationMatrixSystem::on_rulebook_added(const WriteLock &write_lock, size_t index,
