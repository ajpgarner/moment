...
namespace Moment {
    ...
    std::pair<PolynomialToMask::MaskType, PolynomialToMask::MaskType> PolynomialToMask::empty_mask() const {
    ...
    void PolynomialToMask::set_bits(PolynomialToMask::MaskType& real_mask,
                                    PolynomialToMask::MaskType& imaginary_mask,
    ...
    PolynomialToMask::masks_to_sets(const PolynomialToMask::MaskType& real_mask,
                                    const PolynomialToMask::MaskType& imaginary_mask) {
